...
plot(handles.axes1,(1:length_1)/handles.recObj.SampleRate,handles.myRecording(:,1),'r');%×ó
plot(handles.axes2,(1:length_1)/handles.recObj.SampleRate,handles.myRecording(:,2),'g');%ÓÒ
drawnow;
